...
@section('content')
    ...
    <form method="POST" action="{{route('education.store')}}">
        ...
        <div class="mb-3">
            ...
            <input name="school_location" type="text" class="form-control @error('school_location') is-invalid @enderror" id="school_location" aria-describedby="school_location">
        ...
        <div class="mb-3">
            ...
            <input name="degree" type="text" class="form-control @error('degree') is-invalid @enderror" id="degree" aria-describedby="degree">
            @error('degree')
            <span class="invalid-feedback" role="alert">
                {{ $message }}
            </span>
        ...
        <div class="mb-3">
            ...
            <input name="field_of_study" type="text" class="form-control @error('field_of_study') is-invalid @enderror" id="field_of_study" aria-describedby="field_of_study">
        ...
        <div class="mb-3">
            ...
            <input name="graduation_start_date" type="date" class="form-control">
        ...
        <div class="mb-3">
            ...
            <input name="graduation_end_date" type="date" class="form-control">
