...
@section('content')
    ...
    <form method="POST" action="{{ route('register') }}">
      @csrf
        <div class="mb-3">
            <label for="name" class="form-label">FullName(FIO)</label>
        ...
        <div class="mb-3">
            ...
            <input name="date_of_birth" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" id="date_of_birth" aria-describedby="date_of_birth">
            @error('date_of_birth')
            <span class="invalid-feedback" role="alert">
                {{ $message }}
            </span>
        ...
        <div class="mb-3">
            ...
            <input name="phoneNumber" type="text" class="form-control @error('phoneNumber') is-invalid @enderror" id="phoneNumber" aria-describedby="phoneNumber">
            @error('phoneNumber')
            <span class="invalid-feedback" role="alert">
                {{ $message }}
            </span>
